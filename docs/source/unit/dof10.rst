...
Open the |cores3_unit_dof10_accel_example.m5f2| project in UiFlow2.
...
Open the |cores3_unit_dof10_barometer_example.m5f2| project in UiFlow2.

This example shows how to read and display pressure, altitude, and temperature.

UiFlow2 Code Block:

    |barometer_example.png|
...
MicroPython Code Block:
    ...
    .. literalinclude:: ../../../examples/unit/dof10/cores3_unit_dof10_accel_example.py
        :language: python
        :linenos:
...
MicroPython Code Block:
    ...
    .. literalinclude:: ../../../examples/unit/dof10/cores3_unit_dof10_barometer_example.py
        :language: python
        :linenos:
...
.. method:: get_temperature(sensor="pressure")
    :no-index:
...
.. method:: set_sea_level_pressure(pressure)
    :no-index:

    Set the sea-level reference pressure in ``hPa``. The default is 1013.25.

    :param pressure: Reference pressure in hPa.
    :type pressure: float
    :raises ValueError: If pressure is not positive.

    UiFlow2 Code Block:

        |set_sea_level_pressure.png|
