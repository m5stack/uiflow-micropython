...
def setup():
    ...
    wlan.active(True)
    wlan.connect("GL-AXT1800-06a", "m5stack001")
    ...
    modbustcpserver_0 = modbus.ModbusTCPServer("0.0.0.0", 502, device_address=1, verbose=False)
    ...
    modbustcpserver_0.add_coil(0, True)
    modbustcpserver_0.add_coil(1, False)
    modbustcpserver_0.add_discrete_input(0, True)
    modbustcpserver_0.add_discrete_input(1, False)
    modbustcpserver_0.add_holding_register(0, 0x0102)
    modbustcpserver_0.add_holding_register(1, 0x0304)
    modbustcpserver_0.add_input_register(0, 0x0102)
    modbustcpserver_0.add_input_register(1, 0x0304)
