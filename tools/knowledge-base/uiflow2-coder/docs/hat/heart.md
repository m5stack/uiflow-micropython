...
### `HeartHat.set_mode(mode)`
    ...
    - Parameter `mode` (`int`): The detect mode of the HeartHat.
        Options:
...
### `HeartHat.set_led_current(led_current)`
    ...
    - Parameter `led_current` (`int`): The LED current of the HeartHat.
        Options:
...
### `HeartHat.set_pulse_width(pulse_width)`
    ...
    - Parameter `pulse_width` (`int`): The pulse width of the HeartHat.
        Options:
...
### `HeartHat.set_sampling_rate(sampling_rate)`
    ...
    - Parameter `sampling_rate` (`int`): The sampling rate of the HeartHat.
        Options:
