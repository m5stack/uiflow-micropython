...
```
### `ModbusRTUMaster.read_coils(address: int, register: int, quantity: int, timeout: int = 2000)`
...
```
### `ModbusRTUMaster.read_discrete_inputs(address: int, register: int, quantity: int, timeout: int = 2000)`
...
```
### `ModbusRTUMaster.read_holding_registers(address: int, register: int, quantity: int, timeout: int = 2000)`
...
```
### `ModbusRTUMaster.read_input_registers(address: int, register: int, quantity: int, timeout: int = 2000)`
...
```
### `ModbusRTUMaster.write_single_coil(address: int, register: int, value: int, timeout: int = 2000)`
...
```
### `ModbusRTUMaster.write_single_register(address: int, register: int, value: int, timeout: int = 2000)`
...
```
### `ModbusRTUMaster.write_multiple_coils(address: int, register: int, values: list, timeout: int = 2000)`
...
```
### `ModbusRTUMaster.write_multiple_registers(address: int, register: int, values: list, timeout: int = 2000)`
