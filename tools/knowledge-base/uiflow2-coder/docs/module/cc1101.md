...
### `class module.cc1101.CC1101Module(pin_cs = 5, \`
    ...
    - Parameter `freq_khz` (`int`): CC1101 RF frequency in kHz, with a range of 855000 kHz to 928000 kHz.
...
### `set_freq(freq_khz)`
        ...
        - Parameter `freq_khz` (`int`): Frequency in kHz (855000 ~ 928000), default is 868000.
