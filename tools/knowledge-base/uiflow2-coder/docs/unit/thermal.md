...
### `ThermalUnit.get_max_temperature`

    get the max temperature.

### `ThermalUnit.get_min_temperature`

    get the min temperature.

### `ThermalUnit.get_midpoint_temperature`
...
### `ThermalUnit.get_pixel_temperature(x: int, y: int) -> float`
    ...
    - Returns: The temperature of the pixel.

### `ThermalUnit.get_refresh_rate`
...
### `ThermalUnit.get_temperature_buffer() -> list`
    ...
    - Returns: The temperature buffer.

### `ThermalUnit.set_refresh_rate(rate: int) -> None`

    Set the refresh rate.

    - Parameter `rate` (`int`): The refresh rate in Hz.
