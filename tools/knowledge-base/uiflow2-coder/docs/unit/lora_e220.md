...
> Note: Available when LoRaE220JPUnit working mode is 3. Please refer to `working mode table <working-mode>` for the working mode.
...
> Note: Available when the working mode of LoRaE220JPUnit is 0 / 1 / 2. Please refer to `working mode table <working-mode>` for the working mode.
...
> Note: Available when the working mode of LoRaE220JPUnit is 0 or 1. Please refer to `working mode table <working-mode>` for the working mode.
...
### `LoRaE220JPUnit.SUBPACKET_200_BYTE`
...
### `LoRaE220JPUnit.RSSI_AMBIENT_NOISE_ENABLE`
          LoRaE220JPUnit.RSSI_AMBIENT_NOISE_DISABLE

    RSSI ambient noise.

### `LoRaE220JPUnit.TX_POWER_13dBm`
...
### `LoRaE220JPUnit.RSSI_BYTE_ENABLE`
...
### `LoRaE220JPUnit.UART_TT_MODE`
          LoRaE220JPUnit.UART_P2P_MODE

    transmission mode.

### `LoRaE220JPUnit.WOR_500MS`
