...
- Parameter `port` (`tuple`): The port to which the RCA Unit is connected. port[0]: not used, port[1]: dac pin.
...
```
    ...
    RCAUnit class inherits Display class, See `hardware.Display <hardware.Display>` for more details.
