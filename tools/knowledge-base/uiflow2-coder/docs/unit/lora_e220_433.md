...
> Note: Available when LoRaE220433Unit working mode is 3. Please refer to `working mode table <working-mode>` for the working mode.
...
> Note: Available when the working mode of LoRaE220433Unit is 0 / 1 / 2. Please refer to `working mode table <working-mode>` for the working mode.
...
> Note: Available when the working mode of LoRaE220433Unit is 0 or 1. Please refer to `working mode table <working-mode>` for the working mode.
...
### `LoRaE220433Unit.SUBPACKET_200_BYTE`
...
### `LoRaE220433Unit.RSSI_AMBIENT_NOISE_ENABLE`
          LoRaE220433Unit.RSSI_AMBIENT_NOISE_DISABLE

    RSSI ambient noise.

### `LoRaE220433Unit.TX_POWER_22dBm`
...
### `LoRaE220433Unit.RSSI_BYTE_ENABLE`
...
### `LoRaE220433Unit.UART_TT_MODE`
          LoRaE220433Unit.UART_P2P_MODE

    transmission mode.

### `LoRaE220433Unit.WOR_500MS`
