...
set(UIFLOW_ENABLE_M5THINGS 0)
if(MICROPY_BOARD STREQUAL "ESPRESSIF_ESP32_S3_BOX_3" OR MICROPY_BOARD STREQUAL "SEEED_STUDIO_XIAO_ESP32S3")
    set(M5THINGS_COMPONENT_DIR "${CMAKE_CURRENT_LIST_DIR}/../m5stack/components/m5things")
    if(EXISTS "${M5THINGS_COMPONENT_DIR}/CMakeLists.txt")
        set(UIFLOW_ENABLE_M5THINGS 1)
        list(APPEND IDF_COMPONENTS mqtt)
        list(APPEND IDF_COMPONENTS m5things)
    endif()
endif()
unset(M5THINGS_COMPONENT_DIR)
...
target_compile_definitions(${MICROPY_TARGET} PUBLIC
    ...
    BOARD_ID=${BOARD_ID}
    UIFLOW_ENABLE_M5THINGS=${UIFLOW_ENABLE_M5THINGS}
)
