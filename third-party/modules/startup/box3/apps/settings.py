...
class WiFiSetting(AppBase):
    ...
    def on_view(self):
        ...
        self._bg_img.set_src("/system/box3/Setting/wifiServer.png")
    ...
    def _select_ssid_option(self):
        self._bg_img.set_src("/system/box3/Setting/ssid.png")
    ...
    def _select_psk_option(self):
        self._bg_img.set_src("/system/box3/Setting/pass.png")
        self._ssid_label.set_text_color(0x000000, 0xFEFEFE)
    ...
    def _select_server_option(self):
        self._bg_img.set_src("/system/box3/Setting/server.png")
        self._ssid_label.set_text_color(0x000000, 0xFEFEFE)
        self._psk_label.set_text_color(0x000000, 0xFEFEFE)
...
_current_options = {
    100: "/system/box3/Setting/charge100.png",
    500: "/system/box3/Setting/charge500.png",
    900: "/system/box3/Setting/charge900.png",
    1000: "/system/box3/Setting/charge1000.png",
}
...
_boot_options = {
    1: "/system/box3/Setting/bootYes.png",
    2: "/system/box3/Setting/bootNo.png",
}
...
_comlink_options = {
    False: "/system/box3/Setting/comxDisable.png",
    True: "/system/box3/Setting/comxEnable.png",
}
...
_usbpower_options = {
    False: "/system/box3/Setting/usbInput.png",
    True: "/system/box3/Setting/usbOutput.png",
}
...
_buspower_options = {
    False: "/system/box3/Setting/busInput.png",
    True: "/system/box3/Setting/busOutput.png",
}
...
class SettingsApp(AppBase):
    ...
    def on_install(self):
        M5.Lcd.drawImage("/system/box3/Selection/setting_unselected.png", 5 + 62 * 0, 20 + 4)
    ...
    def on_view(self):
        self._origin_x = 0
        self._origin_y = 80
        M5.Lcd.drawImage("/system/box3/Selection/setting_selected.png", 5 + 62 * 0, 20 + 4)
        self._lcd.clear()
        self._lcd.fillRect(4 + 60 + 3, 4 + 108 + 4, 60, 44, 0xDCDDDD)
        self._lcd.fillRect(4 + 60 + 3 + 60 + 3, 4 + 108 + 4, 60, 44, 0xDCDDDD)
        self._lcd.fillRect(4 + 60 + 3 + 60 + 3 + 60 + 3, 4 + 108 + 4, 60, 44, 0xDCDDDD)
        self._lcd.fillRect(4 + 60 + 3 + 60 + 3 + 60 + 3 + 60 + 3, 4 + 108 + 4, 60, 44, 0xDCDDDD)
