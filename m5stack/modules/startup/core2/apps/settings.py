...
class WiFiSetting(AppBase):
    ...
    def _select_ssid_option(self):
        self._bg_img.set_src("/system/core2/Setting/ssid.png")
    ...
    def _select_psk_option(self):
        self._bg_img.set_src("/system/core2/Setting/pass.png")
        self._ssid_label.setTextColor(0x000000, 0xFEFEFE)
    ...
    def _select_server_option(self):
        self._bg_img.set_src("/system/core2/Setting/server.png")
        self._ssid_label.setTextColor(0x000000, 0xFEFEFE)
        self._psk_label.setTextColor(0x000000, 0xFEFEFE)
...
class BatteryChargeSetting(AppBase):
    ...
    def on_view(self):
        ...
        if hasattr(self, "_option_img") == False:
...
_boot_options = {
    ...
    2: "/system/core2/Setting/bootNo.png",
}
...
_comlink_options = {
    False: "/system/core2/Setting/comxDisable.png",
    True: "/system/core2/Setting/comxEnable.png",
}
...
_brightness_options = {
    64: "/system/core2/Setting/screen25.png",
    128: "/system/core2/Setting/screen50.png",
    192: "/system/core2/Setting/screen75.png",
    255: "/system/core2/Setting/screen100.png",
}
...
class SettingsApp(AppBase):
    ...
    def on_view(self):
        self._origin_x = 0
        self._origin_y = 80
        M5.Lcd.drawImage("/system/core2/Selection/setting_selected.png", 5 + 62 * 0, 20 + 4)
        self._lcd.clear()
