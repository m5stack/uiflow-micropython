...
class BatteryChargeSetting(AppBase):
    _current_options = {100: "100mA", 300: "300mA", 700: "700mA", 1000: "1000mA"}
    ...
    def on_launch(self):
        ...
        self._options = generator(self._current_options)
        while True:
    ...
    def on_view(self):
        ...
        self._charge_current_label = Label(
            "100mA",
            220,
            68,
            w=45,
    ...
    def on_ready(self):
        ...
        self._menu_label.setText("Charge Current")
        self._charge_current_label.setText(self._current_options.get(self._current))
    ...
    def on_exit(self):
        del (self._menu_label, self._charge_current_label)
    ...
    async def _btnb_enter_event_handler(self, fw):
        self._handle_charge_current(fw)
...
class BootScreenSetting(AppBase):
    ...
    def on_ready(self):
        ...
        self._menu_label.setText("Boot Screen")
        self._option_img.set_src(self._boot_options.get(self._option))
...
class BrightnessSettingApp(AppBase):
    ...
    def on_ready(self):
        ...
        self._menu_label.setText("Brightness")
        self._brightness_label.setText(self._brightness_options.get(self._brightness))
