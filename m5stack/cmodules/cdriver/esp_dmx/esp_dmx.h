...
#define ESP_DMX_VERSION_ID ((ESP_DMX_VERSION_MAJOR << 16) | (ESP_DMX_VERSION_MINOR << 8) | ESP_DMX_VERSION_PATCH)

/** @brief The version of this library expressed as a string value.*/
#define ESP_DMX_VERSION_LABEL        \
        __XSTRING(ESP_DMX_VERSION_MAJOR) \
        "." __XSTRING(ESP_DMX_VERSION_MINOR) "." __XSTRING(ESP_DMX_VERSION_PATCH) " " __DATE__
