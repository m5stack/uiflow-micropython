...
static const mp_rom_map_elem_t m5_board_member_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_M5Tab5X),         MP_ROM_INT(35) },
    ...
    { MP_ROM_QSTR(MP_QSTR_M5ToughC5),       MP_ROM_INT(33) },
    // non display boards
    ...
    { MP_ROM_QSTR(MP_QSTR_M5CoreMatrix),    MP_ROM_INT(152) },
    { MP_ROM_QSTR(MP_QSTR_M5StampC5),       MP_ROM_INT(153) },
    { MP_ROM_QSTR(MP_QSTR_M5StampC6),       MP_ROM_INT(154) },
    { MP_ROM_QSTR(MP_QSTR_M5StampS3Mini),   MP_ROM_INT(155) },
    // external displays
