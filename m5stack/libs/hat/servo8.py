...
class Servo8:
    ...
    def write_servo_angle(self, ch, angle) -> None:
        ...
        ch -= 1
        self.i2c.writeto_mem(self.addr, self.SERVO_ANGLE_REG + ch, bytearray([angle]))
    ...
    def read_servo_angle(self, ch) -> int:
        ...
        ch = int(max(1, ch))
        ch -= 1
        return self.i2c.readfrom_mem(self.addr, self.SERVO_ANGLE_REG + ch, 1)[0]
    ...
    def write_servo_pulse(self, ch, pulse) -> None:
        ...
        self.i2c.writeto_mem(self.addr, (self.SERVO_PULSE_REG + ch) * 2, bytearray(data))
    ...
    def read_servo_pulse(self, ch) -> int:
        ...
        ch = int(max(1, ch))
        ch -= 1
        buf = self.i2c.readfrom_mem(self.addr, (self.SERVO_PULSE_REG + ch) * 2, 2)
    ...
    def power_ctrl(self, state) -> None:
        ...
        if state:
            ...
            state = 0
        self.i2c.writeto_mem(self.addr, self.POWER_CTRL_REG, bytearray([state]))
    ...
    def get_power_state(self) -> int:
        ...
        """
        return self.i2c.readfrom_mem(self.addr, self.POWER_CTRL_REG, 1)[0]
