...
#define MICROPY_HW_BOARD_NAME               "M5Stack StampS3Mini"
...
#define MICROPY_HW_USB_PRODUCT_FS_STRING "StampS3Mini(UiFlow2)"
#define MICROPY_HW_USB_CDC_INTERFACE_STRING "StampS3Mini(UiFlow2)"
